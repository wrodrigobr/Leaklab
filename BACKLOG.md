...
| AY-28 | **Veredito por semelhanca enquanto o exato nao chega.** Passo 1 (card do admin) e a assinatura do spot ENTREGUES LOCAL 08/09. Medido em prod: semelhanca acerta a acao em 75%, erro/nao-erro em 79%; 60% das decisoes sem no ja teriam vizinho; critico->correto 3%. Proximos: (2) gravar a assinatura no upload e o veredito provisorio SEM mostrar, medindo semelhanca x exato continuamente; (3) card e replay com rotulo 'por semelhanca' e a regra 'semelhanca nunca acusa' como invariante; (4) prioridade da fila: card aberto, provavel desvio, treino. | Um passo por vez, com homologacao. |
