...
| # | item | por que aqui |
|---|---|---|
| AY-3 | **Filtro de volume evidente.** Pedido original do dono: *"este filtro esta muito escondido, temos que pensar uma forma de ficar mais evidente para o jogador ver que os dados sao com base neste filtro"*. 3 propostas esbocadas (frase-nao-botao / barra de escopo / selo por card), CSS no scratchpad. | **e o unico item que o dono pediu e ainda nao foi entregue.** Numero errado na tela ja consertamos; numero certo lido no escopo errado continua enganando. |
