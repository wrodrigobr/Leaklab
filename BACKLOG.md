...
| AY-28 | **Reaproveitamento do acervo de nos pos-flop e ~0%; so textura de board reaproveita.** Simulado em prod (08/09, 24.814 decisoes pos-flop em 30 dias): chave atual 0% (24.805 spots distintos); isomorfismo de naipes 0%; mao por classe 0%; SEM a mao e board exato 0%; SEM a mao e board isomorfo 1%; textura + classe da mao 4%; SEM a mao e textura (carta alta, par, naipes, conexao) 66% (10.035 solves em vez de 24.805). Ou seja: o balde de stack ja e largo (5 faixas), a mao quase nao importa, e o board exato e o que impede o reuso, por combinatoria (22.100 flops x turn x river x posicao x aposta). Decidir: (a) manter exato e priorizar o que solva (fila hoje: 2.197 pendentes, 14h de espera media, 465 falhas); (b) solve por textura para cobertura + exato sob demanda no card (casa com AY-17); (c) card do admin 'Aproveitamento do solver' para acompanhar. | Decisao de produto; o card do admin e meio periodo. |
