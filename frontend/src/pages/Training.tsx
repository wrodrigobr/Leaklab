      ...
      <div className="mx-auto max-w-5xl grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="flex flex-col rounded-xl border border-violet-500/30 bg-violet-500/5 overflow-hidden">
          ...
          <div className="border-t border-violet-500/20 p-4">
            <Link
              to="/academy"
              className="flex w-full items-center justify-center gap-2 rounded-lg bg-violet-500 px-5 py-2.5 font-mono text-sm font-bold uppercase tracking-widest text-white hover:bg-violet-400 transition-colors"
            >
