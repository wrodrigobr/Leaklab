      ...
      <div className="mx-auto max-w-[1440px] px-4 pt-8 pb-28 md:px-8 lg:pb-12">
        ...
        <div className="flex gap-10 items-start">
          ...
          <div className="flex-1 min-w-0 space-y-14">
            ...
            {/* Como cada stat do HUD e calculada: definicao + formula, sem citar outras
                ferramentas (pedido do dono, 07/09). Jargao em ingles por convencao do produto. */}
            <Section id="hud_defs" title={t("hud_defs.title")}>
              ...
              <Table
                ...
                rows={(["vpip", "pfr", "rfi", "three_bet", "fold_to_3bet", "steal", "open_limp", "bb_defense",
