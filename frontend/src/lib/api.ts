...
export const academy = {
  ...
  multiwayQuestion: () =>
    request<AcademyQuestion>("/academy/multiway/question"),

  multiwaySubmit: (selected_index: number, correct_index: number, xp_value: number) =>
    request<AcademySubmitResult>("/academy/multiway/submit", {
      method: "POST",
      body: JSON.stringify({ selected_index, correct_index, xp_value }),
    }),
  ...
  postflopQuestion: () =>
    request<AcademyQuestion>("/academy/postflop/question"),

  postflopSubmit: (selected_index: number, correct_index: number, xp_value: number) =>
    request<AcademySubmitResult>("/academy/postflop/submit", {
      method: "POST",
      body: JSON.stringify({ selected_index, correct_index, xp_value }),
    }),

  sizingQuestion: () =>
    request<AcademyQuestion>("/academy/sizing/question"),

  sizingSubmit: (selected_index: number, correct_index: number, xp_value: number) =>
    request<AcademySubmitResult>("/academy/sizing/submit", {
      method: "POST",
      body: JSON.stringify({ selected_index, correct_index, xp_value }),
    }),
  ...
  combosQuestion: () =>
    request<AcademyQuestion>("/academy/combos/question"),

  combosSubmit: (selected_index: number, correct_index: number, xp_value: number) =>
    request<AcademySubmitResult>("/academy/combos/submit", {
      method: "POST",
      body: JSON.stringify({ selected_index, correct_index, xp_value }),
    }),

  blockersQuestion: () =>
    request<AcademyQuestion>("/academy/blockers/question"),

  blockersSubmit: (selected_index: number, correct_index: number, xp_value: number) =>
    request<AcademySubmitResult>("/academy/blockers/submit", {
      method: "POST",
      body: JSON.stringify({ selected_index, correct_index, xp_value }),
    }),

  positionQuestion: () =>
    request<AcademyQuestion>("/academy/position/question"),

  positionSubmit: (selected_index: number, correct_index: number, xp_value: number) =>
    request<AcademySubmitResult>("/academy/position/submit", {
      method: "POST",
      body: JSON.stringify({ selected_index, correct_index, xp_value }),
    }),

  showdownQuestion: () =>
    request<AcademyQuestion>("/academy/showdown/question"),

  showdownSubmit: (selected_index: number, correct_index: number, xp_value: number) =>
    request<AcademySubmitResult>("/academy/showdown/submit", {
      method: "POST",
      body: JSON.stringify({ selected_index, correct_index, xp_value }),
    }),

  exploitsQuestion: () =>
    request<AcademyQuestion>("/academy/exploits/question"),

  exploitsSubmit: (selected_index: number, correct_index: number, xp_value: number) =>
    request<AcademySubmitResult>("/academy/exploits/submit", {
      method: "POST",
      body: JSON.stringify({ selected_index, correct_index, xp_value }),
    }),
  ...
  drawsQuestion: () =>
    request<AcademyQuestion>("/academy/draws/question"),

  drawsSubmit: (selected_index: number, correct_index: number, xp_value: number) =>
    request<AcademySubmitResult>("/academy/draws/submit", {
      method: "POST",
      body: JSON.stringify({ selected_index, correct_index, xp_value }),
    }),

  threebetQuestion: () =>
    request<AcademyQuestion>("/academy/threebet/question"),

  threebetSubmit: (selected_index: number, correct_index: number, xp_value: number) =>
    request<AcademySubmitResult>("/academy/threebet/submit", {
      method: "POST",
      body: JSON.stringify({ selected_index, correct_index, xp_value }),
    }),

  barrelsQuestion: () =>
    request<AcademyQuestion>("/academy/barrels/question"),

  barrelsSubmit: (selected_index: number, correct_index: number, xp_value: number) =>
    request<AcademySubmitResult>("/academy/barrels/submit", {
      method: "POST",
      body: JSON.stringify({ selected_index, correct_index, xp_value }),
    }),

  termsQuestion: () =>
    request<AcademyQuestion>("/academy/terms/question"),

  termsSubmit: (selected_index: number, correct_index: number, xp_value: number) =>
    request<AcademySubmitResult>("/academy/terms/submit", {
      method: "POST",
      body: JSON.stringify({ selected_index, correct_index, xp_value }),
    }),

  bankrollQuestion: () =>
    request<AcademyQuestion>("/academy/bankroll/question"),

  bankrollSubmit: (selected_index: number, correct_index: number, xp_value: number) =>
    request<AcademySubmitResult>("/academy/bankroll/submit", {
      method: "POST",
      body: JSON.stringify({ selected_index, correct_index, xp_value }),
    }),

  bvbQuestion: () =>
    request<AcademyQuestion>("/academy/bvb/question"),

  bvbSubmit: (selected_index: number, correct_index: number, xp_value: number) =>
    request<AcademySubmitResult>("/academy/bvb/submit", {
      method: "POST",
      body: JSON.stringify({ selected_index, correct_index, xp_value }),
    }),
};
