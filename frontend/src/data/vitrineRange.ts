...
export const VITRINE_RANGE: RangeSet = {
  label: "Open CO (20bb)",
  raise: new Set(["44", "55", "66", "76s", "77", "87s", "88", "97s", "98s", "99", "A2s", "A3s", "A4o", "A4s", "A5o", "A5s", "A6o", "A6s", "A7o", "A7s", "A8o", "A8s", "A9o", "A9s", "AA", "AJo", "AJs", "AKo", "AKs", "AQo", "AQs", "ATo", "ATs", "J7s", "J8s", "J9o", "J9s", "JJ", "JTo", "JTs", "K4s", "K5s", "K6s", "K7s", "K8s", "K9o", "K9s", "KJo", "KJs", "KK", "KQo", "KQs", "KTo", "KTs", "Q5s", "Q6s", "Q7s", "Q8s", "Q9o", "Q9s", "QJo", "QJs", "QQ", "QTo", "QTs", "T7s", "T8s", "T9o", "T9s", "TT"]),
  frequencies: FREQS,
};
