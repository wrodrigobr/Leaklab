...
SUITES = {
    ...
    'engine':    ['test_decision_engine.py', 'test_pote_do_solve.py', 'test_acusacao_precisa_de_base.py', 'test_coerencia_da_recomendacao.py', 'test_equity_vs_random_nao_condena_fold.py', 'test_procedencia_da_camada_viva.py', 'test_recusa_de_gto_declara_motivo.py', 'test_severidade_sem_custo.py', 'test_carta_rasa_3_a_7bb.py', 'test_procedencia_do_veredito.py', 'test_evaluators.py', 'test_pipeline.py',
                  ...
                  'test_webhook_stripe_objeto.py',
                  'test_preco_tem_uma_fonte.py',
                  ...
                  # O historico das maos praticadas mora em `database` (ele e sobre a tabela
    ...
    'database':  ['test_database.py', 'test_score_alinhado_no_insert.py', 'test_google_auth.py', 'test_exclusao_de_usuario.py', 'test_historico_de_pratica.py', 'test_resultado_manual.py', 'test_quota_mensal.py', 'test_fila_de_analise.py', 'test_burst_solver.py', 'test_janela_do_dashboard.py', 'test_escopo_do_dashboard.py', 'test_hud_bate_com_pokertracker.py', 'test_coach_system.py', 'test_notifications.py',
                  ...
                  # ── Guardas da auditoria de 15/09 ────────────────────────────────────────
                  'test_media_de_razao_sai_como_numero.py',
                  'test_schema_nao_deriva_entre_dialetos.py'],
    'llm':       ['test_llm_explainer.py', 'test_gate_de_linguagem_gto.py', 'test_study_plan.py', 'test_study_patterns.py',
                  ...
                  # Guarda da auditoria de 15/09: a copy nao pode negar sala que o parser aceita.
                  'test_copy_cita_as_salas_suportadas.py'],
    'api':       ['test_api_endpoints.py', 'test_teto_de_jam_so_postflop.py', 'test_subscription.py', 'test_partygaming_financials.py',
                  ...
                  'test_guest_teto.py',
                  'test_xp_rota.py',
                  'test_tipos_do_api_ts_batem_com_a_rota.py',
                  'test_limites_de_plano_nao_cravados_no_front.py',
                  'test_proxy_do_vite_cobre_a_api.py'],
    ...
    'gto':       ['test_tree_hash.py',
                  ...
                  # Guarda da auditoria de 15/09: o no que vai para o LLM passa pelo mesmo
                  # filtro do /replay.
                  'test_no_valido_para_o_spot.py'],
