...
SUITES = {
    'engine':    ['test_decision_engine.py', 'test_pote_do_solve.py', 'test_recusa_de_gto_declara_motivo.py', 'test_severidade_sem_custo.py', 'test_carta_rasa_3_a_7bb.py', 'test_procedencia_do_veredito.py', 'test_evaluators.py', 'test_pipeline.py',
